...
import { Header, InputContainer, ScreenContainer, StyledForm, StyledLogo } from '../Styles/HomeStyle.js';
...
const CadastroForm = () => {
  ...
  const {signUp} = useContext(GlobalStateContext);
  ...
  return (
    <ScreenContainer>
      <Header/>
      <InputContainer>
        <StyledLogo>          <p id='main-text'>Informações de Cadastro para Contato</p>
        </StyledLogo>
        <p>Cadastrar</p>
